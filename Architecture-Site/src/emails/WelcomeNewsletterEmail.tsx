...
export const welcomeNewsletterSubject = "Welcome to the Ractysh Network";
              ...
              <Row>
                ...
                <Column className="executive-copy-column" style={styles.executiveCopyColumn}>
                  <Text style={styles.paragraph}>
                    ...
                    exchange operations into one intelligent enterprise network.
                  </Text>
...
function renderWelcomeNewsletterText({
  ...
  return [
    ...
    "Connected To A Higher Standard Of Execution",
    "",
    "The Ractysh ecosystem is built to unite architecture, construction, real estate, trade and private exchange operations into one intelligent enterprise network.",
