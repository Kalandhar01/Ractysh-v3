...
export const WobbleCard = ({
  ...
  return (
    <motion.section
      ...
      className={cn(
        "mx-auto w-full bg-indigo-800 relative overflow-hidden rounded-2xl",
        containerClassName
      )}
    >
      <div
      ...
      >
        <motion.div
          ...
          className={cn("h-full px-5 py-12 sm:px-10 sm:py-20", className)}
        >
          <Noise />
          {children}
        </motion.div>
...
const Noise = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle at 20% 30%, rgba(255,255,255,0.75) 0 1px, transparent 1px), radial-gradient(circle at 70% 65%, rgba(255,255,255,0.45) 0 1px, transparent 1px)",
