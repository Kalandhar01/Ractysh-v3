...
const BREAKPOINT_VALUES = [5, 4, 3, 2];
...
const Masonry: React.FC<MasonryProps> = ({
  ...
  const columns = useMedia(BREAKPOINT_QUERIES, BREAKPOINT_VALUES, 1);
  ...
  return (
    <div ref={containerRef} className="list" style={{ height: gridHeight || undefined }}>
      {grid.map((item) => {
        return (
          <button
            key={item.id}
              ...
              {colorShiftOnHover && (
                <span
                  ...
                  style={{
                    ...
                    width: "100%",
                    height: "100%",
                    background: "linear-gradient(45deg, rgba(56,189,248,0.5), rgba(15,23,42,0.5))",
                    opacity: 0,
                    pointerEvents: "none",
                    borderRadius: "8px",
                  }}
